...
../rng -g 32 -u 0.98 -d 25 -m 0.11 -t 92 >> simulation1_summary.txt


#echo 'manipulating generation rate (interval = 28c ~ 3.0s)' >> simulation4_summary.txt
../rng -g 28 -u 0.98 -d 25 -m 0.11 -t 92 >> simulation1_summary.txt
...
../rng -g 24 -u 0.98 -d 25 -m 0.11 -t 92 >> simulation1_summary.txt
...
../rng -g 20 -u 0.98 -d 25 -m 0.11 -t 92 >> simulation1_summary.txt
...
../rng -g 8 -u 0.98 -d 25 -m 0.11 -t 92 >> simulation1_summary.txt


#echo 'manipulating generation rate (interval = 6c ~ 0.5s)' >> simulation1_summary.txt
../rng -g 6 -u 0.98 -d 25 -m 0.11 -t 92 >> simulation1_summary.txt


#echo 'manipulating generation rate (interval = 4c ~ 0.5s)' >> simulation1_summary.txt
../rng -g 4 -u 0.98 -d 25 -m 0.11 -t 92 >> simulation1_summary.txt
cat output_log.dat >> simulation1_data.txt
