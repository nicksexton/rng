...
{
    OosVars *gv;
    XGlobals xg = {NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, TRUE, TRUE, FALSE, CANVAS_SECOND_ORDER, CANVAS_VARY_DECAY, {10.0, 1.0, 1.0, 40, 8, {0.35, 0.24, 0.12, -0.10, 0.87}}, -1, {}, {}, NULL};
